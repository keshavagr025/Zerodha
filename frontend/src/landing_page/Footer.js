      ...
      <div className="container border-top mt-5">
        <div className="row mt-5">
          ...
          <div className="col">
            ...
            <br />
            <a href="" style={styles.link}>Zerodha.tech</a>
            <br />
            <a href="" style={styles.link}>Press & media</a>
            <br />
            <a href="" style={styles.link}>Zerodha cares (CSR)</a>
            <br />
          </div>
          <div className="col">
            ...
            <br />
            <a href="" style={styles.link}>Z-Connect blog</a>
            <br />
            <a href="" style={styles.link}>List of charges</a>
            <br />
